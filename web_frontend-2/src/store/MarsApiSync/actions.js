...
export const DEVICE_MODEL_MARS = ({
    ...
    return Vue.http.get("https://qaapp.bijlipay.co.in:8985/api/deviceModel?NII=101", {headers: headers})
        .then(response => {
...
export const CITY_MARS = ({
    ...
    console.log("HEADERS_TOKEN_DETAILS-----------", {headers: headers})
    return Vue.http.get("https://qaapp.bijlipay.co.in:8985/api/city", {headers: headers})
        .then(response => {
...
export const REGION_MARS = ({ 
    ...
    console.log("HEADERS_TOKEN_DETAILS-----------", {headers: headers})
    return Vue.http.get("https://qaapp.bijlipay.co.in:8985/api/marsregion", {headers: headers})
        .then(response => {
...
export const LEAD_FORM_MARS = ({
    ...
    console.log("HEADERS_TOKEN_DETAILS-----------", {headers: headers})
    return Vue.http.get("https://qaapp.bijlipay.co.in:8985/api/leadFrom", {headers: headers})
        .then(response => {
...
export const STATE_MARS = ({
    ...
    console.log("HEADERS_TOKEN_DETAILS-----------", {headers: headers})
    return Vue.http.get("https://qaapp.bijlipay.co.in:8985/api/state", {headers: headers})
        .then(response => {
