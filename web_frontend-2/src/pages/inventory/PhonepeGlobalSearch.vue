  ...
  export default {
    ...
    methods: {
      ...
      getFlagKeyByValue(object, value) {
        // console.log("getFlagKeyByValue object------->",object)
        // console.log("getFlagKeyByValue value------->",value)
        // console.log("getFlagKeyByValue object.value------->",object.value)
      ...
      globalSearchSubmit({ pagination }) {
        ...
        console.log("Flags 222222222222222: ---------- : ", this.formData.flag);
        console.log("deCapitalizeFirstLetter ------->",deCapitalizeFirstLetter(sort[0].label.replace('t', 'Y')));
        this.paginationControl.sortBy = this.formData.flag != 2 ? deCapitalizeFirstLetter(sort[0].label.replaceAll(/\s/g, '')) : "c.serialNumber";
        console.log("this.paginationControl.sortBy: ---------- : ",this.paginationControl.sortBy);
        let params = {
