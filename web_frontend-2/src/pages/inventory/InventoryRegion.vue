    ...
    <q-page>
        ...
        <div>
            ...
            <q-table row-key="name" :filter="filter" :data="regionalItems" class="q-py-none" :columns="columns"
                ...
                <q-td slot="body-cell-region" slot-scope="props" :props="props">{{ props.row.region == null ?
                        'NA' : props.row.region.regionAreaName
                }}</q-td>
                <q-td slot="body-cell-device" slot-scope="props" :props="props">{{ props.row.device == null ?
