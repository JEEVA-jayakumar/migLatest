<template>
  <q-page>
    <div>
      <!--START: table title -->
      <div class="col-md-12 q-title q-px-md q-py-md text-weight-regular bottom-border text-grey-9">Lead Approval Tracker</div>
...
export default {
  ...
  methods: {
    ...
    downloadReport() {
      ...
      this.REPORT_LEAD_APPROVAL_TRACKER(this.formData)
        .then(() => {
          this.$q.loading.hide();
          this.$q.notify({
            color: "positive",
