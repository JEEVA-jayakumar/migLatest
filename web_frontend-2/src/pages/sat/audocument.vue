    ...
    <div>
      ...
      <q-table table-class="customTableClass" :data="tableData" :columns="columns" :filter="filter"
        ...
        <template slot="top">
          ...
          <div class="col-2">
            <q-datetime class="q-mr-lg q-py-sm" v-model="formData.fromDate" :min="yesterday" :max="tomorrow"
              float-label="From Date" />
          </div>
          <div class="col-2">
            <q-datetime class="q-mr-lg q-py-sm" v-model="formData.toDate" :min="yesterday" :max="tomorrow"
              float-label="To Date" />
          </div>
          <div class="col-2">
