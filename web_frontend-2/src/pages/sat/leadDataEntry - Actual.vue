...
<q-page>
    <div class="q-ma-md">
        ...
        <q-list>
            <q-collapsible opened icon="info" group="primary" label="Merchant details" sublabel="Device, Exceptions, Payment, MDR" inset-separator>
                <div>
                            ...
                            <div class="group">
                                <q-card v-if="formData.shortLead.kyc" class=" border-1" flat>
                                    <q-card-title class="q-pa-sm bottom-border-dark bg-grey-4">
                                        <div class="row items-center">
                                            <div class="col-auto q-caption text-weight-medium">
                                                Exception KYC
                                            </div>
                                        </div>
                                    </q-card-title>
            ...
            <q-collapsible icon="file_copy" group="primary" label="Documents" sublabel="Related documents" inset-separator>
