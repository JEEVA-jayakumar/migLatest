        ...
        <div class="column group">
          <div class="col-md-12">
            <div class="q-title text-weight-regular">
              <p align="center">
                <strong>Download Bp Region File</strong>
              </p>
            </div>
          </div>
          <div class="col-md-12">
          ...
          <div class="col-md-12 group" align="right">
            <q-btn
              ...
              @click="emitfnshowBpRegionReport()"
              >Cancel</q-btn
            >
            <q-btn
              align="right"
              @click="downloadDeviceBpRegion(formData)"
...
export default {
  props: ["propBpRegionReport"],
  data() {
    return {
      toggleModel: this.propBpRegionReport,
  ...
  methods: {
    ...mapActions("DownloadInventoryBPRegion", ["FETCH_INVENTORY_BP_REGIONS_DATAS"]),
    emitfnshowBpRegionReport() {
      this.$emit("emitfnshowBpRegionReport");
    },
    //Permission creation final submit
    downloadDeviceBpRegion(request) {
      let params = {
      ...
      this.FETCH_INVENTORY_BP_REGIONS_DATAS(params)
        .then(response => {
          this.$emit("emitfnshowBpRegionReport");
          this.$q.loading.hide();
          this.$q.notify({
