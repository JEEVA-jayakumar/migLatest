     ...
     <!-- @hide="emitfnshowAddPartner()"
      ...
      <form>
        <div class="column group">
          <div class="col-md-12">
            <div class="q-title text-weight-regular"><p align="center"><strong>Download Device Merchant File</strong></p></div>
          </div>
          <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      toggleModel: this.propDeviceMerchantReport,
  ...
  methods: {
      ...
      this.$emit("emitfnshowDeviceMerchant");
     },
    //Permission creation final submit
    downloadMerchant(request) {
     let params = {
