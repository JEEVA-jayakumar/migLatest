<template>
       ...
       <!-- @hide="emitfnshowAddPartner()"
        ...
        <form>
          <div class="column group">
            <div class="col-md-12">
              <div class="q-title text-weight-regular"><p align="center"><strong>Download Aggregator Moved TO Scrap File</strong></p></div>
            </div>
            <div class="col-md-12">
  ...
  export default {
    ...
    data() {
      return {
        toggleModel: this.propMovedToScrapList,
    ...
    methods: {
         ...mapActions("DownloadInventoryMovedTOScrap",["FETCH_MOVED_TO_SCRAP_INVENTORY_ALL_DATAS", "FETCH_AGGREGATORS_MOVED_TO_SCRAP_INVENTORY_ALL_DATAS"]),
        emitfnshowMovedToScrapList() {
        this.$emit("emitfnshowMovedToScrapList");
       },
     
       downloadMovedToScrapList(request) {
       let params = {
        ...
        this.FETCH_AGGREGATORS_MOVED_TO_SCRAP_INVENTORY_ALL_DATAS(params)
          .then(response => {
            this.$emit("emitfnshowMovedToScrapList");
            this.$q.loading.hide();
            this.$q.notify({
