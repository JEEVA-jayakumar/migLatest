            ...
            <q-td>
              ...
              <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                <div
                  ...
                  :props="props"
                >
                  <span>{{ col.podNumber != null ? col.podNumber : "NA" }}</span
                  ><br />
                </div>
              </div>
            </q-td>
            ...
            <q-td>
              ...
              <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                <div
                  ...
                  :props="props"
                >
                  <span>{{ col.latitude != null ? col.latitude : "NA" }}</span
                  ><br />
                </div>
              </div>
            </q-td>
            <q-td>
              ...
              <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                <div
                  ...
                  :props="props"
                >
                  <span>{{ col.longitude != null ? col.longitude : "NA" }}</span
                  ><br />
                </div>
              </div>
            </q-td>
            ...
            <q-td>
              ...
              <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                <div
                  ...
                  :props="props"
                >
                  <span>{{ col.partType != null ? col.partType : "NA" }}</span
                  ><br />
                </div>
              </div>
            </q-td>
      ...
      this.FETCH_PHONEPE_CANCELLED_SERVICE_REQUEST_DATAS({ pagination, filter })
        .then(res => {
          ...
          this.paginationControl.page =
            this.getserviceRequestPhonepeCancelledDatas.number + 1;

          // then we update the rows with the fetched ones
          this.tableData = this.getserviceRequestPhonepeCancelledDatas.content;
          this.externalClosedTableData = this.tableData.filter(
            service => service.source == true
          );
          if (this.getserviceRequestPhonepeCancelledDatas.sort != null) {
            this.paginationControl.sortBy = this.getserviceRequestPhonepeCancelledDatas.sort[0].property;
            this.paginationControl.descending = this.getserviceRequestPhonepeCancelledDatas.sort[0].ascending;
          }
