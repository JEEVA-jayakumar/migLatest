          ...
          <q-tabs v-model="selectedTab" class="shadow-1" color="grey-1" @select="goToUnassignedTab">
            ...
            <opened/>
              ...
              <q-tab-pane name="unAssigned">
                  <q-table :data="tableData3" :columns="columnDataUnassigned" table-class="customTableClass"
                      ...
                      <q-td slot="body-cell-serviceReqTicketId" slot-scope="props" :props="props"
                      ...
                      <q-td slot="body-cell-serviceRequestTicketStatus" slot-scope="props" :props="props">
                          <span class="label text-positive"
                      ...
                      <q-td slot="body-cell-kaptureDueDate" slot-scope="props" :props="props">{{
                              props.row.kaptureDueDate == null ? "NA" : props.row.kaptureDueDate | moment("Do MMM Y")
                      }}</q-td>
                      <q-td slot="body-cell-appointmentDate" slot-scope="props" :props="props">{{
                              props.row.appointmentDate == null ? "NA" : props.row.appointmentDate | moment("Do MMM Y")
                      }}</q-td>
                      <q-td slot="body-cell-courierDueDate" slot-scope="props" :props="props">{{
                              props.row.courierDueDate == null ? "NA" : props.row.courierDueDate | moment("Do MMM Y")
                      }}</q-td>
                      <q-td slot="body-cell-scheduleDate" slot-scope="props" :props="props">{{ props.row.scheduleDate
              ...
              <q-tab-pane name="assigned">
                  <q-table :data="tableData1" :columns="columnDataAssigned" table-class="customTableClass"
                          ...
                          <q-tr v-show="props.row.expand" :props="props" class="wordWrapCustom bottom-border">
                              ...
                              <q-td>
                                  ...
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.serviceRequestIssueType != null ? col.serviceRequestIssueType :
                                                  "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              ...
                              <q-td>
                                  <div class="text-left q-caption text-grey-8 text-weight-medium">SubTicket Status
                                  </div>
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                              ...
                              <q-td>
                                  ...
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.serviceRemarks != null ? col.serviceRemarks :
                                                  "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              ...
                              <q-td>
                                  <div class="text-left q-caption text-grey-8 text-weight-medium">Implementation Form
                                  </div>
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.implementationForm != null ? col.implementationForm : "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              </q-td>
                              <q-td>
                                  <div class="text-left q-caption text-grey-8 text-weight-medium">Picture Of Shop
                                  </div>
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.pictureOfShop != null ? col.pictureOfShop : "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              </q-td>
                              ...
                              <q-td>
                                  <div class="text-left q-caption text-grey-8 text-weight-medium">Old Sim Network
                                  </div>
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.oldSimNetwork != null ? col.oldSimNetwork : "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              </q-td>
                              ...
                              <q-td>
                                  <div class="text-left q-caption text-grey-8 text-weight-medium">New Sim Network
                                  </div>
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.newSimNetwork != null ? col.newSimNetwork : "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              </q-td>
                              <q-td>
                                  <div class="text-left q-caption text-grey-8 text-weight-medium">Scan Sim Number
                                  </div>
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.scanSimNumber != null ? col.scanSimNumber : "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              </q-td>
                              <q-td>
                                  ...
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.scanDeviceSerialNumber != null ? col.scanDeviceSerialNumber :
                                                  "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              ...
                              <q-td>
                                  <div class="text-left q-caption text-grey-8 text-weight-medium">Paper Roll Count
                                  </div>
                                  <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                      <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                          :props="props">
                                          <span>{{ col.paperRollCount != null ? col.paperRollCount : "NA"
                                          }}</span><br />
                                      </div>
                                  </div>
                              </q-td>
...
methods: {
    ...
    this.FETCH_PHONEPE_REOPEN_TICKET({ pagination, filter })
      .then((res) => {
        ...
        this.paginationControl1.rowsNumber =
            this.getserviceRequestReopenTicket.totalElements
        this.paginationControl1.page =
            this.getserviceRequestReopenTicket.number + 1

        // then we update the rows with the fetched ones source
        this.tableData3 =
            this.getserviceRequestReopenTicket.content
        ...
        if (this.getserviceRequestReopenTicket.sort != null) {
          this.paginationControl1.sortBy =
              this.getserviceRequestReopenTicket.sort[0].property
          this.paginationControl1.descending =
              this.getserviceRequestReopenTicket.sort[0].ascending
        }
    ...
    this.FETCH_PHONEPE_REOPENED_ASSIGNED_TICKET({ pagination, filter })
      .then((res) => {
        ...
        this.paginationControl.rowsNumber =
                      this.getphonepeAssignedReopenTicket.totalElements
        this.paginationControl.page =
                      this.getphonepeAssignedReopenTicket.number + 1
        ...
        if (this.getphonepeAssignedReopenTicket.sort != null) {
          this.paginationControl.sortBy =
                          this.getphonepeAssignedReopenTicket.sort[0].property
          this.paginationControl.descending =
                          this.getphonepeAssignedReopenTicket.sort[0].ascending
        }
  ...
  assignImplementationUser () {
    ...
    // }
      ...
      self
        .PHONEPE_REOPENED_UNASSIGED_TO_ASSIGNED_STATE(postValues)
        .then((res) => {
