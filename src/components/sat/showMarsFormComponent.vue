<template>
 ...
 :disabled="this.propLeadDeatils.leadStatus == 102"
 ...
 <div v-if="merchant && merchant.salesInformation?.institutionCode == 104 && merchant.additionalInfo" class="row q-col-gutter-sm q-my-xs">
 <div class="col-md-6 col-sm-12 col-xs-12">
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value use-input placeholder="Choose from the below*" color="grey-9" clearable
 ...
 :options="salesPersonOptionsFiltered" @filter="salesPersonFilter" />
 ...
 <div v-if="merchant && merchant.salesInformation?.sharingModelCode == 'T'" class="row q-col-gutter-sm q-my-xs">
 <div class="col-md-6 col-sm-12 col-xs-12">
 ...
 <!-- M => MDR/cash@pos/rent -->
 <div v-if="merchant && merchant.salesInformation?.sharingModelCode == 'M'" class="row q-col-gutter-sm q-my-xs">
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value @blur="v$.merchant.salesInformation?.sharingPartnerCode?.$touch" :error="
 v$.merchant?.salesInformation?.sharingPartnerCode?.$error
 " placeholder="Choose from the below*" color="grey-9"
 ...
 <div v-if="
 v$.merchant?.companyInformation?.registeredAddress?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required -
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value @blur="v$.merchant?.companyInformation?.statezone?.$touch"
 ...
 <div v-if="
 v$.merchant?.companyInformation?.registeredPin?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 <div v-if="
 v$.merchant?.companyInformation?.registeredPin?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select emit-value map-options @blur="v$.merchant.companyInformation?.constitutionName?.$touch" :error="
 ...
 <div v-if="
 v$.merchant?.companyInformation?.constitutionName?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 </div>
 ...
 <div v-if="
 v$.merchant?.companyInformation?.establishYear?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 </div>
 ...
 <div v-if="
 v$.merchant?.companyInformation?.registerNumber?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required -
 Accepts alphanumeric values
 </div>
 <div v-if="
 v$.merchant?.companyInformation?.registerNumber?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value placeholder="Choose from the below*" color="grey-9"
 v-model.trim="merchant.companyInformation.businessType" label="Type of Business"
 ...
 <div v-if="
 v$.merchant?.companyInformation?.contactName?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 <div v-if="
 v$.merchant?.companyInformation?.contactName?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div v-if="
 v$.merchant?.companyInformation?.contactMobile?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 <div v-if="
 v$.merchant?.companyInformation?.contactMobile?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 ">
 <div v-if="
 v$.merchant?.companyInformation?.contactAlternateMobile?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 <div v-if="
 v$.merchant?.companyInformation?.contactAlternateMobile?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div v-if="
 v$.merchant?.companyInformation?.contactPhone?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 <div v-if="
 v$.merchant?.companyInformation?.contactPhone?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div v-if="
 v$.merchant?.companyInformation?.contactEmail?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 <div v-if="
 ...
 <div v-if="
 v$.merchant?.companyInformation?.statementEmail?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 <div v-if="
 v$.merchant?.companyInformation?.statementEmail?.email?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp; Invalid
 email address format
 </div>
 ...
 <div v-for="(partner, index) in viewBinding.partnersArr" :key="index" class="row q-my-xs q-col-gutter-sm"
 ref="parentElement">
 <div class="col-md-12 col-sm-12 col-xs-12">
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-input :error="partnerFieldHasError(index, 'name')" @blur="v$.viewBinding.partnersArr.$touch()" color="grey-9" v-model.trim="viewBinding.partnersArr[index].name"
 ...
 <div class="text-negative q-py-xs group q-caption" v-if="partnerFieldHasError(index, 'name')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 </div>
 ...
 :error="partnerFieldHasError(index, 'dob')" @blur="v$.viewBinding.partnersArr.$touch()" color="grey-9" v-model.trim="viewBinding.partnersArr[index].dob"
 ...
 <div class="text-negative q-py-xs group q-caption" v-if="partnerFieldHasError(index, 'pan')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required -
 provide valid PAN
 </div>
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-input :error="partnerFieldHasError(index, 'address')" @blur="v$.viewBinding.partnersArr.$touch()" color="grey-9"
 v-model.trim="viewBinding.partnersArr[index].address" label="Address* (max 120 characters)" placeholder="Address*" />
 <div class="text-negative" v-if="
 error.field.merchant?.partnerInformation[index]?.address?.alert
 ">
 <MarsErrorResponse :error="error.field.merchant?.partnerInformation[index]" />
 </div>
 <div class="text-negative q-py-xs group q-caption" v-if="partnerFieldHasError(index, 'address')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 </div>
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-input :error="partnerFieldHasError(index, 'pin')" @blur="v$.viewBinding.partnersArr.$touch()" color="grey-9" type="number"
 v-model.trim="viewBinding.partnersArr[index].pin" label="Pincode*" placeholder="Pincode*" />
 <div class="text-negative" v-if="
 error.field.merchant?.partnerInformation[index]?.pin?.alert
 ">
 <MarsErrorResponse :error="error.field.merchant?.partnerInformation[index]" />
 </div>
 <div class="text-negative q-py-xs group q-caption" v-if="partnerFieldHasError(index, 'pin')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required -
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options use-input fill-input hide-selected :error="partnerFieldHasError(index, 'cityRefLabel') || partnerFieldHasError(index, 'cityRefCode')" color="grey-9"
 v-model.trim="viewBinding.partnersArr[index].cityRefLabel" label="City (type min 3 characters)*"
 placeholder="Start typing .*"
 ...
 <div class="text-negative q-py-xs group q-caption" v-if="partnerFieldHasError(index, 'cityRefLabel') || partnerFieldHasError(index, 'cityRefCode')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required -
 Type and choose from the suggestions
 </div>
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options use-input fill-input hide-selected :error="partnerFieldHasError(index, 'stateRefLabel') || partnerFieldHasError(index, 'stateRefCode')" @blur="v$.viewBinding.partnersArr.$touch()"
 color="grey-9" v-model.trim="viewBinding.partnersArr[index].stateRefLabel" label="State (type min 3 characters)*"
 placeholder="Start typing .*"
 ...
 <div class="text-negative q-py-xs group q-caption"
 v-if="partnerFieldHasError(index, 'stateRefCode') || partnerFieldHasError(index, 'stateRefLabel')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required -
 Type and choose from the suggestions
 </div>
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-input :error="partnerFieldHasError(index, 'contactMobile')" @blur="v$.viewBinding.partnersArr.$touch()" color="grey-9" type="tel"
 v-model.trim="viewBinding.partnersArr[index].contactMobile" label="Mobile*" placeholder="Mobile*" />
 <div class="text-negative" v-if="
 ...
 <div class="text-negative q-py-xs group q-caption" v-if="partnerFieldHasError(index, 'contactMobile')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required -
 Accepts only digits
 </div>
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-input :error="partnerFieldHasError(index, 'contactEmail')" @blur="v$.viewBinding.partnersArr.$touch()" color="grey-9" type="email"
 v-model.trim="viewBinding.partnersArr[index].contactEmail" label="Email*" placeholder="Email*" />
 <div class="text-negative" v-if="
 ...
 <div class="text-negative q-py-xs group q-caption" v-if="partnerFieldHasError(index, 'contactEmail')">
 <div>
 <q-icon color="negative" name="warning" />&nbsp;Required -
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value color="grey-9" @blur="v$.merchant?.businessInformation?.weekdayEndHour?.$touch"
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value color="grey-9" @blur="v$.merchant?.businessInformation?.weekendEndHour?.$touch"
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value @blur="
 ...
 <div v-if="
 v$.merchant?.businessInformation?.merchantTypeCode?.required?.$invalid
 ">
 <q-icon color="negative" name="warning" />&nbsp;Required
 </div>
 </div>
 ...
 <div v-if="
 v$.merchant?.businessInformation?.gstId?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value placeholder="Choose from the below*" color="grey-9"
 v-model.trim="merchant.businessInformation.currentPosName" label="Already having a mPOS/POS*"
 ...
 <div v-if="merchant.paymentDetails?.terminalType == 'MPOS'" class="row q-col-gutter-sm q-my-xs">
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value placeholder="Choose from the below*" color="grey-9"
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value clearable placeholder="Choose from the below*" color="grey-9"
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value placeholder="Choose from the below*" color="grey-9"
 v-model.trim="merchant.paymentDetails.rentalMode" label="Rental Mode*"
 ...
 <div class="row group items-center">
 <div v-if="v$.merchant.mdrPlan?.$error" class="col-md-12 text-negative">
 <q-icon color="negative" name="warning" />&nbsp; Error in MDR
 plan fields, kindly check it.
 </div>
 <div v-if="v$.merchant.SharingDiscountFee?.$error" class="col-md-12 text-negative">
 ...
 <div class="col-md-6 col-sm-12 col-xs-12" v-if="merchant?.bankInformation?.bankDetails">
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value placeholder="Choose from the below" color="grey-9"
 v-model.trim="merchant.bankInformation.bankDetails.feeType" label="Fee Type"
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options use-input fill-input hide-selected color="grey-9" @blur="
 ...
 " :model-value="merchant.bankInformation.bankDetails.bankCityName"
 @input-value="val => { merchant.bankInformation.bankDetails.bankCityName = val; }"
 @update:model-value="val => bankCitySelected(val)"
 label="City (type min 3 characters)*" placeholder="Start typing .*"
 :options="bankCityOptionsFiltered" @filter="bankCitySearchFilter" />
 <div class="text-negative" v-if="
 error.field.merchant?.bankInformation?.bankDetails
 ...
 " :model-value="merchant.bankInformation.bankDetails.bankStateName"
 @input-value="val => { merchant.bankInformation.bankDetails.bankStateName = val; }"
 @update:model-value="val => bankStateSelected(val)"
 label="State (type min 3 characters)*" placeholder="Start typing .*"
 :options="bankStateOptionsFiltered" @filter="bankStateSearchFilter" />
 <div class="text-negative" v-if="
 error.field.merchant?.bankInformation?.bankDetails
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
 <q-select map-options emit-value placeholder="Choose from the below"
 color="grey-9" v-model.trim="
 ...
 <div v-if="
 v$.merchant?.bankInformation?.bankDetails?.accountNumber?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div v-if="
 v$.merchant?.bankInformation?.collectionDetails?.chequeNumber?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <div v-if="
 v$.merchant?.bankInformation?.collectionDetails?.upiLink?.minLength?.$invalid
 ">
 <q-icon color="negative" name="warning" />
 &nbsp;Length should be between
 {{
 ...
 <q-select map-options emit-value clearable placeholder="Choose from the below" color="grey-9" v-model.trim="
 ...
 <div class="col-6">
 <q-input color="grey-9" v-model.trim="merchant.remarks" label="Remarks" placeholder="Remarks" />
 </div>
 <div class="col-6">
...
import { useVuelidate } from '@vuelidate/core';
 ...
 // /^[a-zA-Z\s]*$/
 // );
 const alpha = helpers.regex(/^[A-Za-z0-9\s]*$/);
 ...
 if (item && item.label) {
 this.viewBinding.partnersArr[index].cityRefCode = item.value;
 this.viewBinding.partnersArr[index].cityRefLabel = item.label;
 } else {
 this.viewBinding.partnersArr[index].cityRefCode = '';
 this.viewBinding.partnersArr[index].cityRefLabel = '';
 }
 },
 partnerClearCity() {
 ...
 if (item && item.label) {
 this.viewBinding.partnersArr[index].stateRefCode = item.value;
 this.viewBinding.partnersArr[index].stateRefLabel = item.label;
 } else {
 this.viewBinding.partnersArr[index].stateRefCode = '';
 this.viewBinding.partnersArr[index].stateRefLabel = '';
 }
 },
 /* MCC search result */

 /* Sales Person search result */
 salesPersonFilter(terms, update, abort) {
 update(() => {
 this.salesPersonOptionsFiltered = terms
 ? this.COMMON_FILTER_FUNCTION(this.salesPersonOptions, terms)
 ...
 const found = this.mccOptions ? this.mccOptions.find(o => o.label === item || o.value === item) : null;
 ...
 // Restore constitutionName from constitution value if missing (v2 migration fix)
 if (this.merchant.companyInformation.constitution && !this.merchant.companyInformation.constitutionName) {
 const opt = this.merchantOptions.find(o => o.value === this.merchant.companyInformation.constitution);
 if (opt) this.merchant.companyInformation.constitutionName = opt.value;
 }
 ...
 if (error.response?.data?.hasOwnProperty("errorDetails")) {
 let OThis = this;
 _.map(error.response?.data.errorDetails, (actual) => {
 ...
 eval(`OThis.viewBinding.partnersArr[${findPartnersErrorIndex}].${computeSplitted} = ""`);
 ...
 self.$q.loading.hide();
 if (
 error.response?.data?.name == "INVALID APPLICATION NUMBER" &&
 ...
 if (val1) val1.$touch();
 if (val2) val2.$touch();
 if ((val1 && val1.$error) || (val2 && val2.$error)) {
 return true;
 } else {
 return false;
 }
 ...
 if (!this.v$.viewBinding?.partnersArr?.$dirty) return false;
 const errors = this.v$.viewBinding?.partnersArr?.$each?.$response?.$errors?.[index]?.[field];
