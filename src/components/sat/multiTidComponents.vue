            ...
            this.SAVEING_THE_LEAD_STATUS_DETAILS(request)
                ...
                .catch(error => {
                    this.$q.notify({
                        color: "negative",
                        position: "bottom",
                        message: error.response?.data?.message || "Lead Information status update failed!",
                        icon: "clear"
                    });
                    this.$q.loading.hide();
                });
        ...
        getSubTidConfOrCreateSubTids() {
            ...
            this.GET_SUB_TID_LIST(this.merchant).then(response => {
                ...
                if (error.status == 404) {
                    ...
                    this.CREATE_SUB_TIDS_LIST(this.merchant).then(response => {
                        ...
                        this.$q.notify({
                            color: "negative",
                            position: "bottom",
                            message: error.response?.data?.message || "Sub TID creation failed!",
                            icon: "clear"
                        });
                        this.$q.loading.hide();
                    });
                ...
                this.$q.notify({
                    color: "negative",
                    position: "bottom",
                    message: error.response?.data?.message || "Sub TID generation failed!",
                    icon: "clear"
                });
                this.$q.loading.hide();
            });
            ...
            this.CREATE_BASE_TID(this.merchant)
                ...
                .catch(error => {
                    ...
                    this.$q.notify({
                        color: "negative",
                        position: "bottom",
                        message: error.response?.data?.message || "Base TID creation failed!",
                        icon: "clear"
                    });
                    this.$q.loading.hide();
                });
