        ...
        <div>
            ...
            <div class="row bottom-border group q-px-md q-py-md items-center text-weight-regular text-grey-9">
                ...
                <div class="col-md-2">
                    <q-select v-model="formData.region" label="Select Region" radio color="grey-9"
                        :options="regionOptions" @update:model-value="selectedAggregators" />
                </div>
                ...
                <!-- <div class="col-md-2">
                    <q-select color="grey-9" :disable="formData.region == undefined" v-model="aggregator"
                        ...
                        @update:model-value="selectedAggregators" />
                </div> -->
                <div class="col-md-2">
            ...
            <q-table row-key="name" :filter="filter" :rows="regionalItems" class="q-py-none" :columns="columns"
                ...
                <template v-slot:body-cell-region="props">
                    <q-td :props="props">
                        {{ props.row.region == null ? 'NA' : props.row.region.regionAreaName }}
                    </q-td>
                </template>

                <template v-slot:body-cell-device="props">
                    <q-td :props="props">
                        {{ props.row.aggregatorDevice == null ? 'NA' : props.row.aggregatorDevice.deviceName }}
                    </q-td>
                </template>

                <template v-slot:body-cell-aggregator="props">
                    <q-td :props="props">
                        {{ props.row.aggregator == null ? 'NA' : props.row.aggregator.name }}
                    </q-td>
                </template>
