  ...
  <q-page>
    ...
    <div>
      <div class="row bottom-border q-px-md q-py-md items-center">
        <!--START: table title -->
        <div class="col-md-8 q-title text-weight-regular text-grey-9">Aggregator Add Refurbished Devices - Scan & Upload</div>
      ...
      <div class="row bottom-border q-px-md q-py-md items-center text-weight-regular text-grey-9">
        ...
        <div class="col-md-4">
          ...
          <q-select @update:model-value="fnDisableDeviceTypeSelection"  v-model="formData.device.id" label="Select Device Type"
